...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-1999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div className="flex items-center gap-2">
            {/* Image */}
            <img
              className="dark:block h-10 w-10 lg:h-12 lg:w-12"
              src={Logo}
              alt="Logo"
            />
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-2">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <h3 className="mb-4 ml-4 mt-5 text-sm font-semibold text-bodydark2">
                SERVICES
              </h3>
              ...
              <li>
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/forecast' || pathname.includes('forms')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              <li>
               <SidebarLinkGroup
                activeCondition={
                  pathname === '/promotion' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
